...
Phases 0–3 are done (foundation, player shooting, enemies/collision/damage, bullet-hell
emitters + respawn i-frames). **Phase 4 is next:** scrolling background, wave timeline →
STAGE CLEAR, score/lives/bomb HUD, power-up drops, game-over (PLAN.md §5).
